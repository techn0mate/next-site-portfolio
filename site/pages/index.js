    ...
    <>
      ...
      <section className="cto w-full p-3 flex flex-col-reverse md:flex-row justify-center items-center h-auto min-h-screen text-white relative">
        <span className="left md:w-1/2 m-auto text-left">
          ...
          <Link href="https://www.youtube.com/@indgeek/videos" target="_blank" className='custom-btn inline-block border-2 border-white rounded-md my-4 px-6 py-3 hover:bg-white hover:text-zinc-800 transition-all duration-300'><button>My Tech content<svg xmlns="http://www.w3.org/2000/svg"  className="w-7 h-7 absolute" viewBox="0 0 24 24" fill="red" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/><path d="m9.75 15.02 5.75-3.27-5.75-3.27v6.54z"/></svg></button></Link>
        </span>
