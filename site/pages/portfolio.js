...
const projects = [
  ...
  {title: 'Stock down Notifier', url: ['https://github.com/lifeofsoumya/StockAlert', 'https://github.com/lifeofsoumya/StockAlert'], image: '/projects/project-9.jpg', desc: 'StockAlert notifies you if any stock on NIFTY50 is down by more than 10%', tags: ['NodeJS', 'ReactJS', 'EJS', 'MongoDB', 'Keyhasher']},
